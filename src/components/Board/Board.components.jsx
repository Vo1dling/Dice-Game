...
class Board extends React.Component {
	...
	HoldScore = () => {
		if (this.state.playerTurn === 1) {
			this.setState({ p1Score: this.state.p1Score + this.state.p1Temp, playerTurn: 2, p1Temp: 0 },this.ChangeActivePlayer);
		}
		if (this.state.playerTurn === 2) {
			this.setState({ p2Score: this.state.p2Score + this.state.p2Temp, playerTurn: 1, p2Temp: 0 },this.ChangeActivePlayer);
		}
	};
	ChangeThreshold = () => {
			...
			<div className="parent-container">
				...
				<div className="game-container">
					...
					<div className="settings-container">
						...
						<span className="reset-img">asasd</span>	Reset Game
						</button>
